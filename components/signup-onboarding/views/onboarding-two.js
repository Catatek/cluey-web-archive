  ...
  return (
    <Wrapper>
      <Column>
        ...
        <OnboardingTitle>
          How important are social issues to you?
        </OnboardingTitle>
        <Row style={{ marginBottom: 50 }}>
          ...
          <Tooltip
            message={
              "Social issues, in the context of Cluey, refers to how corporations impact people through issues like treatment of workers and suppliers, impacts on customers, and communities."
            }
